...
def show_inventory(host, username, password):
    url = f"http://{host}/ins"
...
if __name__ == "__main__":
    ...
    for device in devices: 
        ...
        result = show_inventory(ip, 'cisco', 'cisco')
        print(result)
        ...
        # produce to Kafka
        producer.produce("ch6_topic_show_inventory", key=record_key, value=record_value, on_delivery=acked)
        producer.poll(0)
